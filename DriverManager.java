...
public class DriverManager {
   ...
   *
   * <p>Returns {@code null} if the driver has not been initialized or has already been quit. Callers
   * that require a live driver should use {@link #requireDriver()} instead.
   *
