 ...
 * Demonstrates the use of iOS-specific locators and cross-platform accessibility IDs.
 */
public class IOSTest extends BaseTest {
  ...
  public void testAppLaunch() {
    try {
      ...
      WebElement element = WaitHelper.waitForVisibility(
          driver, 
          AppiumBy.accessibilityId("main_screen_title"), 
          20
      );
  ...
  public void testIOSTapsAndInputs() {
    try {
      ...
      WebElement loginButton = WaitHelper.waitForClickability(
          driver, 
      ...
      WebElement errorMsg = WaitHelper.waitForPresence(
          driver,
          AppiumBy.iOSNsPredicateString("label == 'Invalid Credentials'"),
          10
      );
